![Header](https://github.com/boyarkinev/boyarkinev/blob/main/assets/images/amtrying.gif)

## Frontend Developer

- 🔭  В поисках работы
- 👨🏼‍💻 Пишу на React, применяю Redux, типизирую с TypeScript
- 📫  Node.JS, Flutter затаились в очереди на изучение
